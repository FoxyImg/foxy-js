...
/** @license js 2012 - imaya [ https://github.com/imaya/js ] The MIT License */

// goog.provide('StreamReader');

// goog.scope(function() {

const USE_TYPEDARRAY = false;
/**
 * ByteArray Reader.
 ...
 * @constructor
 */
export const StreamReader = function(input, opt_start) {
