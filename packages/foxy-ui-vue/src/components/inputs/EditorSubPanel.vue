...
<template>
	<div v-auto-animate class="editor-panel flex flex-col gap-3" :key="`Section ${title}`" :class="{'opacity-50': disabled}">
		<div class="h-[3px] border-t border-b border-t-neutral-200 border-b-neutral-100 -mx-3"></div>
